...
scp -oStrictHostKeyChecking=no -i /home/jenkins/.ssh/gatling-gar.pem /home/jenkins/.m2/repository/com/xebia/tinyapp/0.0.1-SNAPSHOT/tinyapp-0.0.1-SNAPSHOT.war ec2-user@$TOMCAT_IP:$CATALINA_BASE/webapps/
ssh -oStrictHostKeyChecking=no -i /home/jenkins/.ssh/gatling-gar.pem ec2-user@$TOMCAT_IP '/home/ec2-user/startup.sh'
